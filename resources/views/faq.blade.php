...
<head>
    ...
    <style type="text/css">
    	* { padding: 0px; margin: 0px; font-family: Trattatello Verdana; }
    	body { background-color: black; background-image: url("img/starsbg.gif"); color: white; margin: 5px;}
    	...
    	.faq h4 { padding-right: 10px; padding-left: 10px; padding-bottom: 10px; }
    	.list { box-shadow: 0; margin: 15px; }
    </style>
</head>
<body>
	<div class="box">
		<div class="faq">
			<h3>¿Qué se puede postear?</h3>
			<h4>Te diré lo que no está permitido:</h4>
			<div class="list">
				<ul>
					<em>
			...
			<h3>¿Que información se recolecta del usuario?</h3>
			<h4>Recogemos su dirección IP automáticamente cuando crea o actualiza publicaciones. Esta información NUNCA va a ser utilizada para identificar al usuario, solo tiene fines administrativos. De igual manera, MyChan no hace estudios demográficos, de intereses/comportamiento y, sobre todo, no envía información a terceros. </h4>
			<h5 style="text-align: center; font-size: x-small; color: white;">Cualquier similitud con vampiros.ml es pura coincidencia ;)</h5>
		</div>
	</div>
	<div>
